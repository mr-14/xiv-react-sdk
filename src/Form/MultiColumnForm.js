...
const MultiColumnForm = ({ fields, values, readonly, profile, onFieldChange, classes, border, className }) => {
  if (!border) {
...
MultiColumnForm.defaultProps = {
  border: true,
}

export default withStyles(styles, { withTheme: true })(MultiColumnForm)